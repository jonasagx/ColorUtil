...
/**
 * The Tinycolor class provides methods to manipulate HSL (Hue, Saturation
...
public class Tinycolor {
	...
	/**
	 * Create a Tinycolor object using an RGB Color object.
	 *
	...
	/**
	 * Create a Tinycolor object using individual HSL values and a default
	 * alpha value of 1.0.
	 *
	...
	/**
	 * Create a Tinycolor object using individual HSL values.
	 *
	 ...
	 * @param alpha the alpha value between 0 - 1
	 */
	public Tinycolor(float[] hsl, float alpha) {
		this.hsl = hsl;
		this.alpha = alpha;
		rgb = toRGB(hsl, alpha);
	}
	...
	/**
	 * Create a RGB Color object based on this Tinycolor with a different
	 ...
	 * Tinycolor. This is a convenience method. The complementary color is
	...
	public String toStringHsl() {
		String toString = "Tinycolor[h=" + hsl[0] +
				",s=" + hsl[1] +
				",l=" + hsl[2] +
				",alpha=" + alpha + "]";
...
//		System.out.println(h  + " " + s + " " + l);
	...
	public int getBrightness() {
		return (rgb.getRed() * 299 + rgb.getGreen() * 587 + rgb.getBlue() * 114) / 1000;
	}
